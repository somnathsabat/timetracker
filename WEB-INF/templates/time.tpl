...
<!--<link id="styleSheet0" rel="stylesheet" href="stylesheets/common.css">-->




<script>
//diable the previous link
...
{/if}
<tr>
<td align="right">{$i18n.label.category} (*):</td>
 <td>{$forms.timeRecordForm.category.control}</td>
