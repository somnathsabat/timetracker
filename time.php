...
if ($request->isPost()) {
  ...
  if ($request->getParameter('btn_submit')) {
    //$two = $i18n->getKey('error.category');
    ...
    if ($err->no()) {
      ...
      // echo '<pre>';
     // echo $request->getParameter('category');exit;
      // print_r("$reques");exit;
...
//$cvalue[] = ttUserHelper::Category();

//$smarty->assign('category', ttUserHelper::getCategory());
//$smarty->assign('category',$db->getRow($sql));
