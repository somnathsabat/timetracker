...
$group_by_options['categoryname'] = $i18n->getKey('form.reports.group_by_categoryname');



 
 //$group_by_options['date'] = 'date';
...
// $i18n->getkey('value');
//$group_by_options['category'] = $i18n->getKey('form.reports.group_by_category');
